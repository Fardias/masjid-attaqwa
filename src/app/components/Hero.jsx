...
export default function Hero() {
    return (
        <div className="relative overflow-hidden rounded-xl bg-amber-50 ">
            ...
            ">
                <img src="hero.jpeg" alt="masjid" className="mb-5 md:mb-0 rounded-md md:w-[300px] md:h-[250px] object-cover" />
                <div className="max-w-xl 
                ">
                    <h1 className="text-4xl md:text-3xl font-bold mb-4 md:mb-1">Selamat Datang di Masjid At-Taqwa</h1>
